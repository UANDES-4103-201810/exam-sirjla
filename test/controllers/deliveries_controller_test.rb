...
class DeliveriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create delivery" do
    assert_difference('Delivery.count') do
      post deliveries_url, params: { delivery: { address_1: @delivery.address_1, adress_2: @delivery.adress_2, phone: @delivery.phone } }
    end
  ...
  test "should update delivery" do
    patch delivery_url(@delivery), params: { delivery: { address_1: @delivery.address_1, adress_2: @delivery.adress_2, phone: @delivery.phone } }
